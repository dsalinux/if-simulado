...
public class LoginView extends AbstractManager {
    ...
    private String url;
    private static final String RETURN_DEFAULT = "index.jsf";
    ...
    public void redirecionarPermissao() {
        url = RETURN_DEFAULT + "?erro_permissao=true";
        redirecionar();
    }
    ...
    public void redirecionarLogin() {
        try {
            ...
            try {
                ...
                FacesContext.getCurrentInstance().getExternalContext().redirect(RETURN_DEFAULT);
                Logger.getLogger(LoginView.class.getName()).log(Level.SEVERE, null, ex);
